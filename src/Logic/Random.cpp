...
std::mt19937& Random::getGenerator() { return randGenerator; }
...
float Random::randFloat() { return getInstance()._randFloat(); }

float Random::randFloat(float max) { return getInstance()._randFloat(0.f, max); }

float Random::randFloat(float min, float max) { return getInstance()._randFloat(min, max); }

int Random::randInt() { return getInstance()._randInt(); }

int Random::randInt(int max) { return getInstance()._randInt(0, max); }

int Random::randInt(int min, int max) { return getInstance()._randInt(min, max); }
